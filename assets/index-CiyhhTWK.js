const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-D47Hu6OW.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-Dw8KX9ga.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bm;function ng(){return bm||(bm=1,function(s){function i(C,W){var $=C.length;C.push(W);e:for(;0<$;){var we=$-1>>>1,v=C[we];if(0<f(v,W))C[we]=W,C[$]=v,$=we;else break e}}function u(C){return C.length===0?null:C[0]}function o(C){if(C.length===0)return null;var W=C[0],$=C.pop();if($!==W){C[0]=$;e:for(var we=0,v=C.length,O=v>>>1;we<O;){var G=2*(we+1)-1,V=C[G],U=G+1,re=C[U];if(0>f(V,$))U<v&&0>f(re,V)?(C[we]=re,C[U]=$,we=U):(C[we]=V,C[G]=$,we=G);else if(U<v&&0>f(re,$))C[we]=re,C[U]=$,we=U;else break e}}return W}function f(C,W){var $=C.sortIndex-W.sortIndex;return $!==0?$:C.id-W.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;s.unstable_now=function(){return m.now()}}else{var h=Date,k=h.now();s.unstable_now=function(){return h.now()-k}}var w=[],b=[],_=1,L=null,Q=3,F=!1,ae=!1,oe=!1,ge=typeof setTimeout=="function"?setTimeout:null,Ye=typeof clearTimeout=="function"?clearTimeout:null,xe=typeof setImmediate<"u"?setImmediate:null;function be(C){for(var W=u(b);W!==null;){if(W.callback===null)o(b);else if(W.startTime<=C)o(b),W.sortIndex=W.expirationTime,i(w,W);else break;W=u(b)}}function ie(C){if(oe=!1,be(C),!ae)if(u(w)!==null)ae=!0,Ne();else{var W=u(b);W!==null&&cn(ie,W.startTime-C)}}var X=!1,Me=-1,Ee=5,Ae=-1;function x(){return!(s.unstable_now()-Ae<Ee)}function M(){if(X){var C=s.unstable_now();Ae=C;var W=!0;try{e:{ae=!1,oe&&(oe=!1,Ye(Me),Me=-1),F=!0;var $=Q;try{n:{for(be(C),L=u(w);L!==null&&!(L.expirationTime>C&&x());){var we=L.callback;if(typeof we=="function"){L.callback=null,Q=L.priorityLevel;var v=we(L.expirationTime<=C);if(C=s.unstable_now(),typeof v=="function"){L.callback=v,be(C),W=!0;break n}L===u(w)&&o(w),be(C)}else o(w);L=u(w)}if(L!==null)W=!0;else{var O=u(b);O!==null&&cn(ie,O.startTime-C),W=!1}}break e}finally{L=null,Q=$,F=!1}W=void 0}}finally{W?ee():X=!1}}}var ee;if(typeof xe=="function")ee=function(){xe(M)};else if(typeof MessageChannel<"u"){var Je=new MessageChannel,tn=Je.port2;Je.port1.onmessage=M,ee=function(){tn.postMessage(null)}}else ee=function(){ge(M,0)};function Ne(){X||(X=!0,ee())}function cn(C,W){Me=ge(function(){C(s.unstable_now())},W)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(C){C.callback=null},s.unstable_continueExecution=function(){ae||F||(ae=!0,Ne())},s.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ee=0<C?Math.floor(1e3/C):5},s.unstable_getCurrentPriorityLevel=function(){return Q},s.unstable_getFirstCallbackNode=function(){return u(w)},s.unstable_next=function(C){switch(Q){case 1:case 2:case 3:var W=3;break;default:W=Q}var $=Q;Q=W;try{return C()}finally{Q=$}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(C,W){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var $=Q;Q=C;try{return W()}finally{Q=$}},s.unstable_scheduleCallback=function(C,W,$){var we=s.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?we+$:we):$=we,C){case 1:var v=-1;break;case 2:v=250;break;case 5:v=1073741823;break;case 4:v=1e4;break;default:v=5e3}return v=$+v,C={id:_++,callback:W,priorityLevel:C,startTime:$,expirationTime:v,sortIndex:-1},$>we?(C.sortIndex=$,i(b,C),u(w)===null&&C===u(b)&&(oe?(Ye(Me),Me=-1):oe=!0,cn(ie,$-we))):(C.sortIndex=v,i(w,C),ae||F||(ae=!0,Ne())),C},s.unstable_shouldYield=x,s.unstable_wrapCallback=function(C){var W=Q;return function(){var $=Q;Q=W;try{return C.apply(this,arguments)}finally{Q=$}}}}(Qo)),Qo}var ym;function tg(){return ym||(ym=1,Zo.exports=ng()),Zo.exports}var Xo={exports:{}},rn={};/**
 * @license React
